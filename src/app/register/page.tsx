...
export default function RegisterPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-sm px-8 py-16">
      <h1 className="mb-6 font-serif text-3xl text-foreground">Sign up</h1>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <label className="flex flex-col gap-1 text-sm text-foreground">
          Password <span className="text-foreground/50">(min. 8 characters)</span>
          <input
            type="password"
            required
            minLength={8}
      ...
      <p className="mt-4 text-sm text-foreground/60">
        ...
        <Link href="/login" className="text-board underline">
          Log in
        </Link>
      </p>
    </div>
