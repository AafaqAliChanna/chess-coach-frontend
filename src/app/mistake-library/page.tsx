    ...
    <div className="px-8 py-12">
      ...
      {notDeployed ? (
        ...
        <>
          ...
          {data && (
            <>
              <p className="mb-6 text-sm text-foreground/60">{data.totalMistakes} mistakes on record</p>
                  ...
                  {accumulated.map((entry) => {
                    ...
                    return (
                      <div key={`${entry.gameId}-${entry.plyNumber}`} className="border border-hairline p-4">
                        ...
                        <p className="mb-1 text-sm font-semibold text-foreground">{entry.gameTitle}</p>
